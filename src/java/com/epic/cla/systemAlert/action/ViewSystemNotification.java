...
import com.epic.cla.systemAlert.service.ViewSystemNotificationService;
 ...
 * @author nipun_t
 */
public class ViewSystemNotification extends ActionSupport implements ModelDriven<ViewSystemNotificationInputBean>, AccessControlService {

    private ViewSystemNotificationService service = new ViewSystemNotificationService();
    ViewSystemNotificationInputBean inputBean = new ViewSystemNotificationInputBean();
    ...
    public String XSLcreat() {
        ...
        try {
            ...
            Object object = ExcelReportSystemNotification.generateExcelReport(inputBean);
    ...
    @Override
    public ViewSystemNotificationInputBean getModel() {
        try {
            service.getProfileList(inputBean);
            inputBean.setRiskLevelList(Util.getRiskLevelList());
            inputBean.setReadStatusList(Util.getReadStatusList());
            service.getCriticalAlerts(inputBean);
            service.getWarnings(inputBean);
        } catch (Exception ex) {
            ex.printStackTrace();
            LogFileCreator.writeErrorToLog(ex);
        }
    ...
    private boolean applyUserPrivileges() {
        ...
        List<TaskBean> tasklist = new Common().getUserTaskListByPage(PageVarList.VIEW_SYSTEM_NOTIFICATION, request);
    ...
    public boolean checkAccess(String method, int userRole) {
        ...
        applyUserPrivileges();
        String page = PageVarList.VIEW_SYSTEM_NOTIFICATION;
        String task = null;
