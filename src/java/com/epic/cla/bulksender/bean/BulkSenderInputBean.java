 ...
 * @author dimuthu_h
 */
public class BulkSenderInputBean {
    ...
    private List<BulkSenderBean> gridModel;
    ...
    public void setReci_mobile(String reci_mobile) {
        this.reci_mobile = reci_mobile;
    }
    ...
    public List<BulkSenderBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<BulkSenderBean> gridModel) {
