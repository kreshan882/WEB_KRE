 ...
 * @author tharaka
 */
public class UserActivityAuditInputBean {
    ...
    private List<UserActivityAuditDataBean> gridModel;
    ...
    public List<UserActivityAuditDataBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<UserActivityAuditDataBean> gridModel) {
