 ...
 * @author dimuthu_h
 */
public class CallCenterInputBean {
    ...
    private List<CallCenterBean> gridModel;
    ...
    public List<CallCenterBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<CallCenterBean> gridModel) {
