        ...
        try {
            if (doValidationAdd(inputBean)) {
                ...
                if (service.addData( inputBean)) {
                    DBProcesses.insertHistoryRecord(getSub().getUsername(), Module.USER_MANAGEMENT,PageVarList.USER_PROFILE_MANAGEMENT, TaskVarList.ADD, SystemMessage.USRPROFILE_ADD + " for " + inputBean.getProfilename(),request.getRemoteAddr());
    ...
    public String Update() {
        try { 
                ...
                if (service.updateData(inputBean)) { 
                    ...
                    DBProcesses.insertHistoryRecord(getSub().getUsername(),Module.USER_MANAGEMENT, PageVarList.USER_PROFILE_MANAGEMENT, TaskVarList.UPDATE, SystemMessage.USR_PROFILE_UPDATED, request.getRemoteAddr());
    ...
    public String Delete() {
        try {
            ...
            if(service.deleteData( inputBean)){
                 DBProcesses.insertHistoryRecord(getSub().getUsername(),  Module.USER_MANAGEMENT, PageVarList.USER_PROFILE_MANAGEMENT, TaskVarList.DELETE,SystemMessage.USRPROFILE_DELETED,request.getRemoteAddr());
