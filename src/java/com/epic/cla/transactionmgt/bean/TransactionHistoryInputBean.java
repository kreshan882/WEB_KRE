 ...
 * @author nipun_t
 */
public class TransactionHistoryInputBean {
    ...
    private List<TransactionHistoryBean> gridModel;
    ...
    public List<TransactionHistoryBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<TransactionHistoryBean> gridModel) {
