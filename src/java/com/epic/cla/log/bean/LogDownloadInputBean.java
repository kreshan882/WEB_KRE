...
public class LogDownloadInputBean {
    ...
    //Table data
    private List<LogFileDataBean> gridModel=new ArrayList<LogFileDataBean>();
    ...
    private Map<String,String> logFileType=Util.getLogTypeList();
    ...
    public List<LogFileDataBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<LogFileDataBean> gridModel) {
    ...
    public Map<String, String> getLogFileType() {
        return logFileType;
    }

    public void setLogFileType(Map<String, String> logFileType) {
