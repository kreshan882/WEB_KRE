...
import com.epic.cla.transactionmgt.service.TransactionHistoryService;
 ...
 * @author nipun_t
 */
public class TransactionHistory extends ActionSupport implements ModelDriven<TransactionHistoryInputBean>, AccessControlService {

    private TransactionHistoryInputBean inputBean = new TransactionHistoryInputBean();
    ...
    @Override
    public TransactionHistoryInputBean getModel() {
        return inputBean;
    }
